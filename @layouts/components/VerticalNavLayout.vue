...
export default defineComponent({
  ...
  setup(props, { slots }) {
    ...
    return () => {
      ...
      const verticalNav = h(
        VerticalNav,
        { isOverlayNavActive: isOverlayNavActive.value, toggleIsOverlayNavActive, class: { 'layout-vertical-nav-collapsed': props.collapsed } },
        {
      ...
      return h(
        'div',
        {
          class: [
            ...
            props.collapsed && 'layout-vertical-nav-collapsed',
