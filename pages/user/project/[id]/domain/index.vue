      ...
      <VCard>
        ...
        <VCardText>
          <VForm ref="addFormRef">
            ...
            <VSelect v-model="newDomain.type" label="Type" :items="['landingpage', 'antiblock', 'bucket', 'web', 'admin', 'callback', 'api', 'entry']" density="comfortable" class="mb-3" variant="outlined" />
      ...
      <VCard>
        ...
        <VCardText>
          <VForm ref="editFormRef">
            ...
            <VSelect v-model="editingItem.type" label="Type" :items="['landingpage', 'antiblock', 'bucket', 'web', 'admin', 'callback', 'api', 'entry']" density="comfortable" class="mb-3" variant="outlined" />
    ...
    <VDialog v-model="isBulkEditDialogVisible" max-width="500">
      <VCard>
        ...
        <VCardText>
          ...
          <VSelect v-model="bulkForm.type" :items="['landingpage', 'antiblock', 'bucket', 'web', 'admin', 'callback', 'api', 'entry']" label="Type" clearable density="comfortable" variant="outlined" class="mb-3" />
