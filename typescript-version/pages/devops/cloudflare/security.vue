            ...
            <template v-for="z in pagedZones" :key="z.zone_id">
              ...
              <template v-if="expandedZones[z.zone_id]">
                ...
                <tr v-for="r in rulesMap[z.zone_id]" :key="r.rule_id">
                  ...
                  <td style="width: 300px !important; max-width: 300px !important; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;"><code class="text-caption">{{ r.rule_id }}</code></td>
